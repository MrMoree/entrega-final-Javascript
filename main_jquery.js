...
$("#botonesJson").append('<button class="btn btn-primary btn-lg" id="btn1">Ver Meses Anteriores</button>');
let bandera_json = 0;
...
$("#botonesJson").append('<button class="btn btn-primary btn-lg" id="btn5">POSTEAR VALORES JSON</button>');
    ...
    $("#btn5").click(() => {
        ...
        $.ajax({
            ...
            success: function (mandoMes) {
                $body.append('<p>lo tuyo no es trap lo tuyo es basura</p>')
            },
        })
